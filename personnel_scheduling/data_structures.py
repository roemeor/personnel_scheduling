# AUTOGENERATED! DO NOT EDIT! File to edit: 00_data_stuctures.ipynb (unless otherwise specified).

__all__ = ['is_work', 'get_end_period_block', 'get_next_period', 'ActivityBlock',
